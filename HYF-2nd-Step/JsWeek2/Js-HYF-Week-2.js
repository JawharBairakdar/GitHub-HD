...
// Q.17
// Changing o2 it will cahnge o3 becuase o3 is just let's say (a new name) for o2
...
Q.9 // That what makes me "mix" every thing with each other the answer is >> veihcleType([colorCar],[carType],[carAge]); By setting what you want here the out put will be at line 113
...
function colorCar(color) {
    ...
    // if you print a (blue) color it will return [a blue] but if you prints an (Aqua) color it will return [an Aqua]
    return color;
}
...
// The Arrow You Can Do't Just Like The Following newTypes = Types.map( (item) => item + "s" );
// The Map Is A (Higher Order Function) And It's Just Like Filter But It Moves The Itemes NOT JUST Printing Thim Out
